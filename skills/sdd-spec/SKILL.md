...
- **obsidian**: Read and follow `skills/_shared/obsidian-convention.md`. Read `sdd/{change-name}/proposal` (required). Write `sdd/{change-name}/spec.md` with frontmatter and wikilinks. If Obsidian CLI unavailable, use direct filesystem writes.
