...
- **obsidian**: Read and follow `skills/_shared/obsidian-convention.md`. Read `sdd/{change-name}/explore` (optional). Write `sdd/{change-name}/proposal.md` with frontmatter and wikilinks to dependencies. If Obsidian CLI unavailable, use direct filesystem writes.
